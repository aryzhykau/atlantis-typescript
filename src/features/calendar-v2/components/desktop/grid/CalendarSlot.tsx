...
import EnhancedDroppableSlot from '../../shared/drag-drop/EnhancedDroppableSlot';
...
export const CalendarSlot: React.FC<CalendarSlotProps> = ({
  ...
  // Wrap the drop handler to inject events for conflict check
  const handleDropWithEvents = (
    event: any,
    sourceDay: any,
    sourceTime: any,
    targetDay: any,
    ...
    return handleTrainingDrop(event, sourceDay, sourceTime, targetDay, targetTime, events, isDuplicate);
  };
