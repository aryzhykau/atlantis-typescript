...
export function ClientDeleteModal({ onConfirm, onCancel }: { onConfirm: () => void; onCancel: () => void }) {
    ...
    return (
        ...
        >
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
                Удаление клиента является <strong style={{ color: theme.palette.error.main }}>необратимым</strong> действием.
            </Typography>
            <Box
                sx={{
                    maxHeight: "200px",
            ...
            >
                <Typography variant="body2" sx={{ mb: 1 }}>
                    Вместе с данными о клиенте будут удалены все записи о:
                </Typography>
                <List>
                    {[
                        "Платежах",
                ...
                <Typography variant="body2" sx={{ mt: 2 }}>
                    В результате удаления клиента, при наличии активных платежей, информация и статистика о расходах может быть{" "}
            ...
            <Typography variant="caption" color="warning" display="block" fontStyle="italic" sx={{ mb: 3 }}>
                Рекомендуется деактивировать клиентов. Используйте удаление только в крайних случаях.
            </Typography>
