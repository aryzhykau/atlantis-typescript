...
export function SubscriptionDeleteModal({ onConfirm, onCancel }: { onConfirm: () => void; onCancel: () => void }) {
    ...
    return (
        ...
        >
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
                Удаление вида абонемента является <strong style={{ color: theme.palette.error.main }}>необратимым</strong> действием.
            </Typography>
            <Box
                sx={{
                    maxHeight: "200px",
            ...
            >
                <Typography variant="body2" sx={{ mb: 1 }}>
                    Вместе с данными об абонементе будут удалены все записи о:
                </Typography>
                <List>
                    {[
                        "Активном абонемента у клиентов",
                        "Тренировках",
                        "Платежах",
                ...
                <Typography variant="body2" sx={{ mt: 2 }}>
                    В результате удаления абонемента, при наличии активных платежей, информация и статистика о расходах может быть{" "}
